...
const About = () => (
  ...
  >
    ...
    <Card
      ...
      size="square"
      type="text"
      title={<Heading type="h1" text="Who are we?" />}
    />
    <Card
      image={Library1}
      alt="Cover Image"
      ...
      title={
        <div>
          ...
          Our team of curators meticulously crafts playlists that cater to a variety of moods and needs.  We source music from all corners of the globe, ensuring you have a diverse and calming soundscape to explore."
          />
        </div>
      }
    />
