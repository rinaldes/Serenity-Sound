...
const History = () => (
  ...
  >
    ...
    <Card
      ...
      type="text"
      content={
        <Text text="Today, Serenity offers a vast library of music, personalized features, and a user-friendly app to help you find moments of calm in your everyday life." />
      }
    />
  </section>
);
